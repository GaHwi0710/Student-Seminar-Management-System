<?php
 ...
 $menu = [
    'student' => [
        ...
        ['icon' => '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>', 'label' => 'Danh sách hội thảo', 'link' => 'student/seminars.php'],
    ...
    'admin' => [
        ...
        ['icon' => '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>', 'label' => 'Quản lý người dùng', 'link' => 'admin/users.php'],
    ...
    'organizer' => [
        ...
        ['icon' => '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg>', 'label' => 'Quản lý hội thảo', 'link' => 'organizer/seminars.php'],
        ['icon' => '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>', 'label' => 'Xét duyệt bài', 'link' => 'organizer/papers.php'],
    ]
];
...
<aside class="sidebar" id="sidebar">
    <a href="<?php echo base_url('index.php'); ?>" style="text-decoration: none; color: inherit; padding: 20px; border-bottom: 1px solid var(--border); display: flex; align-items: center; gap: 12px;">
        <div style="width: 40px; height: 40px; background: var(--accent); border-radius: 10px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>
        </div>
        <div>
            <div style="font-weight: 700;">FBU Seminar</div>
            <div style="font-size: 11px; color: var(--fg-muted);" class="uppercase"><?php echo $role; ?></div>
        </div>
    </a>
    
    <nav style="flex: 1; padding: 15px 0; overflow-y: auto;" id="nav-menu">
        <?php 
        $items = $menu[$role] ?? [];
        foreach ($items as $item): 
            $active = (strpos($item['link'], $current_page) !== false) ? 'active' : '';
        ?>
    ...
    <div style="padding: 15px; border-top: 1px solid var(--border);">
        <div style="display: flex; align-items: center; gap: 10px;">
            <div style="width: 36px; height: 36px; border-radius: 50%; background: var(--bg-tertiary); display: flex; align-items: center; justify-content: center; font-weight: 600; font-size: 14px;" id="user-avatar-nav"><?php echo $avatar; ?></div>
            <div style="flex: 1;">
                <div style="font-size: 13px; font-weight: 600;" id="user-name-nav"><?php echo $name; ?></div>
                <div style="font-size: 11px; color: var(--fg-muted);" id="user-id-nav"><?php echo $code; ?></div>
            </div>
            <a href="<?php echo base_url('logout.php'); ?>" class="btn btn-icon" style="padding: 8px; background: transparent;" title="Dang xuat">
